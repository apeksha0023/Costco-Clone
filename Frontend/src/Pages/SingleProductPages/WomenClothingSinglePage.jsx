...
const WomenClothingSinglePage = () => {
  const [data1,setData1]=useState({});
    ...
    useEffect(()=>{
        fetch(`https://costco-backend-1.onrender.com/womenCloth/get-womenClothproducts/${_id}`)
        .then(e=>e.json())
        .then(e=>setData1(e.womenCloth))
         })
 ...
 return(
  ...
  <>
      ...
      <Box w={600} pt={20} pl={10}><img src={data1?.img} alt="" /></Box>
        <Box>
        ...
        <Box textAlign="center" marginTop={12}><Button p={2} width={200} size='lg' backgroundColor="#c8102e" color="white" border="1px solid black">ADD TO CART</Button></Box>
