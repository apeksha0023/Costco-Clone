...
const MenClothingSinglePage = () => {
  const [data1,setData1]=useState({});
    const{_id}=useParams()

    useEffect(()=>{
        fetch(`https://costco-backend-1.onrender.com/menCloth/get-menClothproducts/${_id}`)
        .then(e=>e.json())
        .then(e=>setData1(e.menCloth))
         })
...
export default MenClothingSinglePage