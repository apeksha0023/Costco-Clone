...
useEffect(() => {
    fetch('https://costco-backend-1.onrender.com/computer/get-computerproducts')
      .then((e) => e.json())
      .then((e) => setData(e.computer))
  ...
  return(
    <>
      ...
      <Text  fontWeight={400} fontSize={"30px"} p={[5, 5, 10, 10]}>
       ...
       <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)',border:"2px",textAlign:"center",justifyContent:"center"}}>
      { data.map((ele) => (
