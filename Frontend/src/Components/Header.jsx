    ...
    return (
      <Box>
        <Text
          ...
          bg={
            "linear-gradient(to right, #005dab 0%, #005dab 100%)"
          }
          p={0.5}
        >
        $250-$450 OFF Select MacBook Pro M3
        </Text>
        <Flex
          gap={8}
        ...
        >
         ...
         <Link to={"/patio-covers"}><Text fontWeight={600} color={"white"} cursor={"pointer"}>
            Location
          </Text></Link> 
        </Flex>
